...
const PriceWithButton = ({ product, isHome }) => {
    return (
        <div className="flex flex-col items-center justify-center gap-6">
            <div className="flex flex-row justify-evenly lg:justify-around w-4/5 lg:w-full">
                <motion.span
                    ...
                    transition={{ delay: isHome ? 3.8 : 0.8, duration: 0.6 }}
                ...
                <motion.span
                    ...
                    transition={{ delay: isHome ? 3.8 : 0.8, duration: 0.5 }}
            ...
            <motion.div
                ...
                transition={{ delay: isHome ? 4 : 1, duration: 0.8 }}
